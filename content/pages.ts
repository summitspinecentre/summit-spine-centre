    ...
    tabs: [
      {
        id:               'desk-worker',
        label:            'Desk Worker',
        image:            '/images/home/demographics/desk-worker.jpg',
        ...
        conditions: [
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Sustained forward-head posture strains the muscles and joints that support your neck — especially after hours in front of a screen.' },
          { label: 'Tech Neck',              slug: 'tech-neck',                icon: 'Monitor',    description: 'The modern epidemic: hours looking down at devices compresses the lower cervical spine and accelerates wear.' },
          { label: 'Headaches',              slug: 'headaches-migraines',      icon: 'Brain',      description: 'Tension headaches that build through the afternoon are often driven by tight neck muscles and restricted cervical joints.' },
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'Prolonged sitting compresses spinal discs, tightens hip flexors, and slowly trains your low back to ache.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Disc pressure from long hours of sitting can irritate the sciatic nerve and send pain down the leg.' },
          { label: 'Upper Back & Shoulders', slug: 'upper-back-shoulder-pain', icon: 'Dumbbell',   description: 'Rounded shoulders and a hunched upper back from keyboard work create chronic tension that rarely resolves on its own.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Pain doesn\'t follow job descriptions. Whatever you\'re dealing with, you\'re welcome here — even if it doesn\'t fit neatly on this list.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
      {
        ...
        image:            '/images/home/demographics/manual-labourer.jpg',
        ...
        conditions: [
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'Repeated bending, lifting, and sustained awkward postures put cumulative stress on spinal discs and joints.' },
          { label: 'Disc Herniation',        slug: 'disc-herniation',          icon: 'Layers',     description: 'Heavy lifting and sudden strain are among the most common triggers for disc herniation in working-age adults.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Disc pressure from physical labour can compress the sciatic nerve, sending pain, numbness, or weakness into the leg.' },
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Overhead work and awkward angles load the cervical spine throughout a shift in ways that add up fast.' },
          { label: 'Upper Back & Shoulders', slug: 'upper-back-shoulder-pain', icon: 'Dumbbell',   description: 'Repetitive lifting and carrying strains the upper back and rotator cuff — often going unaddressed until it becomes a serious problem.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Your work puts demands on every part of your body. If you\'re hurting — even somewhere unexpected — we can help figure it out.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
      {
        ...
        image:            '/images/home/demographics/weekend-warrior.jpg',
        ...
        conditions: [
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'Athletic loading compresses and rotates the spine in ways that everyday movement doesn\'t — and the cumulative effect catches up.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Sport-related disc injuries can put pressure on the sciatic nerve and shut down your training without warning.' },
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Contact sports, cycling, and heavy lifts all load the cervical spine — and a stiff neck limits everything else.' },
          { label: 'Sports Injuries',        slug: 'sports-injuries',          icon: 'Trophy',     description: 'Sprains, strains, and repetitive overuse injuries that flare up every time you try to push harder.' },
          { label: 'Upper Back & Shoulders', slug: 'upper-back-shoulder-pain', icon: 'Dumbbell',   description: 'Overhead athletes and lifters are especially prone to upper back and shoulder dysfunction that limits performance.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Weekend warriors see it all. If something\'s been nagging you, don\'t wait for it to turn into something that forces you to stop.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
      {
        id:               'parent',
        label:            'Parent',
        image:            '/images/home/demographics/parent.jpg',
        ...
        conditions: [
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Looking down while nursing, feeding, or watching little ones adds real strain over thousands of hours.' },
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'Lifting, bending, carrying, and sleeping in awkward positions changes your spinal load completely.' },
          { label: 'Postpartum Back Pain',   slug: 'postpartum-back-pain',     icon: 'Baby',       description: 'Hormonal changes, core weakness, and new physical demands make postpartum back pain extremely common — and very treatable.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Altered posture during and after pregnancy can irritate the sciatic nerve and cause pain that radiates into the leg.' },
          { label: 'Upper Back & Shoulders', slug: 'upper-back-shoulder-pain', icon: 'Dumbbell',   description: 'Carrying babies and toddlers strains the shoulder girdle in ways that don\'t resolve on their own with rest.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Parenting is physical. No matter what\'s hurting, if it\'s limiting what you can do with your kids — that\'s exactly what we\'re here for.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
      {
        id:               'active-senior',
        label:            'Active Senior',
        image:            '/images/home/demographics/active-senior.jpg',
        ...
        conditions: [
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'Age-related disc changes, arthritis, and years of use make low back pain increasingly common — and very responsive to the right care.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Spinal stenosis and degenerative disc changes are leading causes of sciatic pain in older adults.' },
          { label: 'Spinal Stenosis',        slug: 'spinal-stenosis',          icon: 'Minimize2',  description: 'Narrowing of the spinal canal compresses nerves and can limit how far you can walk, stand, or stay active.' },
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Cervical degeneration and arthritis make neck stiffness and reduced range of motion increasingly common with age.' },
          { label: 'Headaches',              slug: 'headaches-migraines',      icon: 'Brain',      description: 'Cervicogenic headaches — originating from the neck — are more prevalent after decades of spinal wear.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Staying active is one of the best decisions you can make. Whatever comes up along the way, we\'re here to keep you moving.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
      {
        id:               'tradesperson',
        label:            'Tradesperson',
        image:            '/images/home/demographics/tradesperson.jpg',
        ...
        conditions: [
          { label: 'Low Back Pain',          slug: 'low-back-pain',            icon: 'Activity',   description: 'On-site demands — repeated bending, lifting, and sustained positions — strain the lumbar spine every single shift.' },
          { label: 'Disc Herniation',        slug: 'disc-herniation',          icon: 'Layers',     description: 'Tradespeople are among the highest-risk groups for disc herniation, and it\'s one of the leading causes of lost work days.' },
          { label: 'Neck Pain',              slug: 'neck-pain',                icon: 'ArrowDown',  description: 'Overhead work, confined spaces, and sustained awkward positions load the cervical spine in ways that accumulate over a career.' },
          { label: 'Sciatica',               slug: 'sciatica',                 icon: 'Zap',        description: 'Disc problems from trade work are a leading cause of sciatic pain — the kind that sends shooting pain down the leg.' },
          { label: 'Upper Back & Shoulders', slug: 'upper-back-shoulder-pain', icon: 'Dumbbell',   description: 'Tool use, carrying materials, and repetitive reaching chronically strain the upper back and shoulders.' },
          { label: 'Something else?',                                           icon: 'HelpCircle', description: 'Tradespeople keep the world running. If something\'s hurting and slowing you down on the job, we want to help you stay on it.' },
        ],
        cta: { label: 'Get My Personalized Plan', href: 'https://summitspine.ca/booking/' },
      },
    ],
